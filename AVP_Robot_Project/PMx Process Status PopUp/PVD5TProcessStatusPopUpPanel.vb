...
Public Class PVD5TProcessStatusPopUpPanel
...
#Region "Private methods"
    ...
    Protected Overrides Sub CreateStatusTree()
        Try
            ...
            For Each ctrl As Control In tbPVD5T.Controls
    ...
    Public Sub TargetInstall(ByVal Target1Insall As Boolean, ByVal Target2Insall As Boolean, ByVal Target3Insall As Boolean, ByVal Target4Install As Boolean, ByVal Target5Install As Boolean)
        Try
            tbPVD5T.ColumnStyles(0).Width = 146
            tbPVD5T.ColumnStyles(1).Width = 65
            tbPVD5T.ColumnStyles(2).Width = 65
            ...
            If Target5Install = False Then

                Me.lblT5Usage.Enabled = False
                Me.txtT5UsageRB.Enabled = False
            End If
