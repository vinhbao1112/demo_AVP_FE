...
Public Class KeyPad
    ...
    Private m_IsCheckInvalidCharacter As Boolean = False
    Private m_RemoveSpecialKey As Boolean = False
    Private m_CurrentSelectionStart As Integer = 0
    Private isEnableBtnColon As Boolean = False
    Private m_isremovespace As Boolean = False
    Private m_isEnableBtnAt As Boolean = False
    ...
    Private Sub ChangeCase()
        If Me.ShiftStatus Then
            btnShift.Image = Global.AVP_Robot_Project.My.Resources.Resources.Sensor_Green
        Else
            btnShift.Image = Global.AVP_Robot_Project.My.Resources.Resources.Sensor_Black
        End If
        Dim control As Control
        For Each control In MyBase.Controls
    ...
    ' Mouse up on Message
    Private Sub lblMessage_MouseUp(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles lblMessage.MouseUp
        Me.doDrag = False
    End Sub

    ' Mouse down on Message
    Private Sub lblMessage_MouseDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles lblMessage.MouseDown
        Me.doDrag = True
        Me.baseX = e.X
        Me.baseY = e.Y
    End Sub

    ' Mouse mouse on Message
    Private Sub lblMessage_MouseMove(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles lblMessage.MouseMove
        If Me.doDrag Then
            Dim VerticalChanged As Integer = (Me.baseX - e.X)
            Dim HorizonChanged As Integer = (Me.baseY - e.Y)
            MyBase.Left = (MyBase.Left - VerticalChanged)
            MyBase.Top = (MyBase.Top - HorizonChanged)
        End If
    End Sub
    ...
    Private Sub txtDisplay_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtDisplay.TextChanged
        Dim currentSelection = m_CurrentSelectionStart
    ...
    Public Sub Enable_DisableBtnColon(ByVal isEnable As Object)
