...
Public Class StatusCoronaWafer
    Inherits StatusObject
#Region "Class Constants & Variables"
    Private m_bscBinaryStatusControl As CoronaWafer
#End Region
...
#Region "Properties"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Property ManagedBinaryStatusControl() As CoronaWafer
        Get
            Return m_bscBinaryStatusControl
        End Get
        Set(ByVal value As CoronaWafer)
...
#Region "Construtor and Destructor"
    ...
    ''' <remarks></remarks>
    Public Sub New(ByVal bscBinaryStatusControl As CoronaWafer)
        Try
