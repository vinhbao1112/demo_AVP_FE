...
Public Class StatusFlashingLabel
    Inherits AVPControls.StatusObject

#Region "Class Constants & Variables"
    Private m_lblLabel As FlashingLabel
#End Region
...
#Region "Properties"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Property ManagedLabel() As FlashingLabel
        Get
            Return m_lblLabel
        End Get
        Set(ByVal value As FlashingLabel)
            m_lblLabel = value
        End Set
    End Property
#End Region
...
#Region "Construtor and Destructor"
    ...
    ''' <remarks></remarks>
    Public Sub New(ByVal lblManagedLabel As FlashingLabel)
        Try
    ...
    Protected Overrides Sub UpdateUI(ByVal arg As Object)
        Try
            ...
            If Not String.IsNullOrEmpty(Value) Then
                ...
                m_lblLabel.StartFlashing()
            Else
                m_lblLabel.Text = String.Empty
                m_lblLabel.StopFlashing()
            End If
