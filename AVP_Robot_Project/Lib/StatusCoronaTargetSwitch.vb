...
Public Class StatusCoronaTargetSwitch
...
#Region "Public Methods"
    Protected Overrides Sub UpdateUI(ByVal arg As Object)
        Try
            ...
            If objPanel.ChamberType = SystemModule.ModuleType.PVD5T Then
                Dim objPVD5TPanel As PVD5TPanel = CType(objPanel, PVD5TPanel)
                objPVD5TPanel.TurnOnOffTargetxSwitch(arg)
            Else
                Dim objCoronaPanel As CoronaPanel = CType(objPanel, CoronaPanel)
                objCoronaPanel.TurnOnOffTargetxSwitch(arg)
            End If
