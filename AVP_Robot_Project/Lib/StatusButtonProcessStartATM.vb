...
Public Class StatusButtonProcessStartATM
...
#Region "Public Methods"
    ...
    Protected Overrides Sub UpdateUI(ByVal arg As Object)
        Try
            ...
            If Value = START Then
                ContainerForm.CycleATM.CycleATMPanel.btnStartATM.Text = Value

            Else
                ContainerForm.CycleATM.CycleATMPanel.btnStartATM.Text = "ABORT"
