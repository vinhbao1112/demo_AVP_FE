...
Public Class CORONA_BiasPowerSupply
...
#Region "Init for DC Target"
    ...
    Public Property ISShowPulse() As Boolean
        ...
        Set(ByVal value As Boolean)
            ...
            Else
                If m_strType_Of_DC = AVPLib.SystemModule.Power_Supply_Model.AE_PULSE_DC Then
                    lblPulseWidth.Text = "Pulse Width (µs)"
                End If
    ...
    Public WriteOnly Property PSType() As String
        Set(ByVal value As String)
            If value = "DCTarget" Then
                ...
                lblMagnatron.Visible = True
                txtMagnatron.Visible = True
...
#End Region
    ...
    Friend Overrides Sub Header_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Try
            ...
            Dim ChamberModule As AVPLib.SystemModule = _
                                AVPLib.ContainerData.GetRobotConfig(Me.Parent.Name) ''get preset config file
            If (Me.Name = BIAS_POWER_SUPPLY_STR AndAlso m_lstSpecialType_PowerSupply.Contains(ChamberModule.BiasPowerModel)) OrElse _
    ...
    Private Sub btnTarget4Switch_StatusChange(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnTarget4Switch.StatusChange, btnTarget3Switch.StatusChange, btnTarget2Switch.StatusChange, btnTarget1Switch.StatusChange
        If Me.Name = "RFTargetPowerSupply" Then
            If btnTarget1Switch.Status = SL_CustomButton.DisplayStatus.Off _
              ...
              AndAlso btnTarget4Switch.Status = SL_CustomButton.DisplayStatus.Off Then
            ...
            If btnTarget1Switch.Status = SL_CustomButton.DisplayStatus.On Then
                ...
                btnMag1RotationStart.Visible = True
            ...
            ElseIf btnTarget2Switch.Status = SL_CustomButton.DisplayStatus.On Then
                ...
                btnMag2RotationStart.Visible = True
            ...
            ElseIf btnTarget3Switch.Status = SL_CustomButton.DisplayStatus.On Then
                ...
                btnMag3RotationStart.Visible = True
            ...
            ElseIf btnTarget4Switch.Status = SL_CustomButton.DisplayStatus.On Then
                ...
                btnMag4RotationStart.Visible = True
