...
Public Class PVD5TChamberControl
    ...
    Private m_shutter5Visible As Boolean = True
    ...
    Private m_shutter5Status As DisplayStatus = DisplayStatus.Unknow
...
#Region "Config Properties"
    ...
    <DefaultValue(GetType(Single), "-10")>
    ...
    Public Property Shutter5Visible() As Boolean
        Get
            Return m_shutter5Visible
        End Get
        Set(ByVal value As Boolean)
            If m_shutter5Visible <> value Then
                m_shutter5Visible = value
                Shutter5.Visible = m_shutter5Visible
            End If
        End Set
    End Property
    ...
    <DefaultValue(GetType(Integer), "8")>
...
#Region "Status Properties"
    ...
    <DefaultValue(GetType(ConstEnum.enumWaferStatus), "eWaferNone")>
    ...
    <DefaultValue(GetType(DisplayStatus), "Unknow")>
    ...
    <DefaultValue(GetType(DisplayStatus), "Unknow")>
    Public Property Shutter5Status() As DisplayStatus
        Get
            Return m_shutter5Status
        End Get
        Set(ByVal value As DisplayStatus)
            If m_shutter5Status <> value Then
                m_shutter5Status = value
                Shutter5.Status = m_shutter5Status
            End If
        End Set
    End Property
...
#Region "Paint Control Methods"
    ...
    Private Sub PaintImage()
        Dim imgChamber As Bitmap = My.Resources.Resources.PVD5TChamber
...
#Region "Events"
    ...
    Private Sub PVD4ChamberControl_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Shutter4.Location = New Point(69, 94)
        Shutter5.Location = New Point(172, 84)
        Shutter1.Location = New Point(261, 98)
        Shutter2.Location = New Point(206, 117)
        Shutter3.Location = New Point(92, 116)
    ...
    Private Sub btnCtxMenu_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCtxMenu.Click
        Try
            Dim CoronaParent As PVD5TPanel = ContainerForm.ChamberPanel(Me.Parent.Name) ''must be Corona Panel
...
#Region "Status Methods"
    ...
    Protected Overrides Sub CreateStatusTree()
        Try
            ...
            Dim sShutter5 As New SL_StatusValve(Shutter5)
            ...
            m_stoStatusObject.AddChild(sShutter5)
            ...
            Shutter5.ParentStatusObj = m_stoStatusObject
        Catch ex As Exception
            AVPLib.Log.avpLogger.Error(ex.ToString())
        End Try
    End Sub
    ...
    Public Sub SetOnlineOfflineContainerBox(ByVal blnIsOnline As Boolean)
        ...
        Shutter5.Enabled = Not blnIsOnline
