Public Class StatusThirdStatusControl
    Inherits AVPControls.StatusObject
#Region "Class Constants & Variables"
    Private m_bscThirdStatusControl As ThirdStatusControl
#End Region
...
#Region "Properties"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Property ManagedThirdStatusControl() As ThirdStatusControl
        Get
            Return m_bscThirdStatusControl
        End Get
        Set(ByVal value As ThirdStatusControl)
            m_bscThirdStatusControl = value
        End Set
    End Property
#End Region
...
#Region "Construtor and Destructor"
    ...
    ''' <remarks></remarks>
    Public Sub New(ByVal bscThirdStatusControl As ThirdStatusControl)
        Try
            m_bscThirdStatusControl = bscThirdStatusControl
            Me.Name = m_bscThirdStatusControl.Name
...
#Region "Public Methods"
    ...
    Protected Overrides Sub UpdateUI(ByVal arg As Object)
        Try
            ...
            Dim enmStatus As ThirdStatusControl.DisplayStatus = CType([Enum].Parse(GetType(ThirdStatusControl.DisplayStatus), Value), ThirdStatusControl.DisplayStatus)
            m_bscThirdStatusControl.Status = enmStatus
        Catch ex As Exception
            AVPLib.Log.avpLogger.Error(ex.ToString())
        End Try
    End Sub
