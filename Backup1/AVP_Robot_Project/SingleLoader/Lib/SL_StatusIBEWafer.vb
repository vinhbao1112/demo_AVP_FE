...
Public Class SL_StatusIBEWafer
    Inherits AVPControls.StatusObject

#Region "Class Constants & Variables"
    Private m_bigcgButton As IBE_WaferInside
#End Region
...
#Region "Properties"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Property ManagedIgCgButton() As IBE_WaferInside
        Get
            Return m_bigcgButton
        End Get
        Set(ByVal value As IBE_WaferInside)
            m_bigcgButton = value
        End Set
    End Property
#End Region
...
#Region "Construtor and Destructor"
    ...
    ''' <remarks></remarks>
    Public Sub New(ByVal bigcgButton As IBE_WaferInside)
        Try
