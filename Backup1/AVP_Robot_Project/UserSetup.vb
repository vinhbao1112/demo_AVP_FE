...
#Region "Load Form"
    ...
    ''' <remarks></remarks>
    Public Sub LoadUserDetail(ByVal Username As String)
        Try
           ...
           ' Me.txtPassword.Text = EncryptionHelper.Decrypt(User.Password)
            ...
            For Each dbChamber As AVPLib.DBChamber In User.ListOfDBChamber.Values
                ...
                ''' IF ANYIBE ONLY SHOW ONE IBE CHAMBER
                If (dbChamber.ChamberType = "IBE" AndAlso AVPLib.ContainerDAO.Enable_ANYIBE_Mode AndAlso hasAddAnyIBE = True) Then
                    Continue For
                End If
                ...
                If dbChamber.ChamberType = "IBE" AndAlso AVPLib.ContainerDAO.Enable_ANYIBE_Mode Then
                    rootNode.Text = dbChamber.ChamberType
                Else
                ...
                For Each dbGroup As AVPLib.DBParameterGroup In dbChamber.ListGroupParameters
                    ...
                    For Each dbParameter As AVPLib.DBParameter In dbGroup.Parameters
                        If Utils.CheckParamRecipe_Visible(dbParameter.Name, dbGroup.GroupCode, dbChamber.ChamberName) Then
                            'Parameter Node
...
#End Region
    ...
    ''' Paint border
    ''' </summary>
    Private Sub UserSetup_Paint(ByVal sender As System.Object, ByVal e As System.Windows.Forms.PaintEventArgs) Handles MyBase.Paint
