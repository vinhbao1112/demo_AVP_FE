Namespace Driver
    Public Class KepwareVentValveDriver
        ...
        Public Function OpenVentValve() As Boolean Implements IValveDriver.Open
            AVPLib.Log.avpLogger.Debug("Enter KepwareVentValveDriver.OpenVentValve")
            ...
            End Try
            AVPLib.Log.avpLogger.Debug("Leave KepwareVentValveDriver.OpenVentValve")
