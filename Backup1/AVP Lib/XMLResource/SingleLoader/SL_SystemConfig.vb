...
"        </SubSystem>" & _
"        <SubSystem>" & _
"          <Name>WaterPumpInstalled</Name>" & _
"          <Value>1</Value>" & _
"        </SubSystem>" & _
"        <SubSystem>" & _
"          <Name>CryoInstalled</Name>" & _
"          <Value>1</Value>" & _
"        </SubSystem>" & _
"        <SubSystem>" & _
...
"    <!--Alarms-->" & _
"    <Action Name=""Alarm.RedStatus On"" Value=""TM.TMC.RO.Stack_Light_Red=True;TM.TMC.RO.Stack_Light_Buzzer=True"" />" & _
"    <Action Name=""Alarm.RedStatus Off"" Value=""TM.TMC.RO.Stack_Light_Red=False;TM.TMC.RO.Stack_Light_Buzzer=False"" />" & _
"    <Status Name=""Alarm.RedStatus On"" Value=""TM.TMC.RO.Stack_Light_Red=True"" />" & _
"    <Status Name=""Alarm.RedStatus Off"" Value=""TM.TMC.RO.Stack_Light_Red=False"" />" & _
"    <Action Name=""Alarm.OrangeStatus On"" Value=""TM.TMC.RO.Stack_Light_Orange=True"" />" & _
"    <Action Name=""Alarm.OrangeStatus Off"" Value=""TM.TMC.RO.Stack_Light_Orange=False"" />" & _
"    <Status Name=""Alarm.OrangeStatus On"" Value=""TM.TMC.RO.Stack_Light_Orange=True"" />" & _
"    <Status Name=""Alarm.OrangeStatus Off"" Value=""TM.TMC.RO.Stack_Light_Orange=False"" />" & _
"    <Action Name=""Alarm.GreenStatus On"" Value=""TM.TMC.RO.Stack_Light_Green=True"" />" & _
"    <Action Name=""Alarm.GreenStatus Off"" Value=""TM.TMC.RO.Stack_Light_Green=False"" />" & _
"    <Status Name=""Alarm.GreenStatus On"" Value=""TM.TMC.RO.Stack_Light_Green=True"" />" & _
"    <Status Name=""Alarm.GreenStatus Off"" Value=""TM.TMC.RO.Stack_Light_Green=False"" />" & _
...
"    <!--Door sensor-->" & _
"    <Status Name=""Loader.DoorSensorStatus On"" Value=""TM.TMC.DI.Lid_Sensor_FB=True"" />" & _
"    <Status Name=""Loader.DoorSensorStatus Off"" Value=""TM.TMC.DI.Lid_Sensor_FB=False"" />" & _
"    <!--Pressure-->" & _
...
"      <Item DisplayGroup=""TM.TMC.DI"" PropertyName=""Loader.DoorSensorStatus"" KepServerName=""TM.TMC.DI.Lid_Sensor_FB"" DataType=""Boolean"" Desc="""" />" & _
...
"      <Item DisplayGroup=""TM.TMC.RO"" PropertyName=""Alarm.OrangeStatus"" KepServerName=""TM.TMC.RO.Stack_Light_Orange"" DataType=""Boolean"" Desc="""" />" & _
"      <Item DisplayGroup=""TM.TMC.RO"" PropertyName=""Alarm.GreenStatus"" KepServerName=""TM.TMC.RO.Stack_Light_Green"" DataType=""Boolean"" Desc="""" />" & _
"      <Item DisplayGroup=""TM.TMC.RO"" PropertyName=""Alarm.RedStatus"" KepServerName=""TM.TMC.RO.Stack_Light_Red"" DataType=""Boolean"" Desc="""" />" & _
"      <Item DisplayGroup=""TM.TMC.RO"" PropertyName="""" KepServerName=""TM.TMC.RO.Stack_Light_Buzzer"" DataType=""Boolean"" Desc="""" />" & _
"    </Group>" & _
"  </KepServerTagsDef>" & _
...
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SLFixture.btnShutterOpen</Key>" & _
"      <Value>Would you like to Open Shutter ?</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SLFixture.btnShutterClose</Key>" & _
"      <Value>Would you like to Close Shutter ?</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
...
"    <!--Status panel-->" & _
"    <MessageText>" & _
"      <Key>SL.SLFixture.btnMotionInitialized.On</Key>" & _
"      <Value>Would you like to Turn MotionInitialized On ?</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SLFixture.btnMotionInitialized.Off</Key>" & _
...
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.tabSource.btnSourceManual</Key>" & _
"      <Value>Would you like to Turn On Source Manual ?</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.tabSource.btnSourceAuto</Key>" & _
...
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SL_PopUpPanel.btnAutoRegen.On</Key>" & _
"      <Value>Would you like to Start Auto Cryo Regen ?</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SL_PopUpPanel.btnAutoRegen.Off</Key>" & _
"      <Value>Would you like to Abort Auto Cryo Regen ?</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SL_PopUpPanel.btnAutoPowerDown.On</Key>" & _
"      <Value>Would you like to Auto Cryo Power Down On ?</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SL_PopUpPanel.btnAutoPowerDown.Off</Key>" & _
...
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SLFixture.btnFlowCoolPump.On</Key>" & _
"      <Value>Would you like to Turn Pump Power On ?</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SLFixture.btnFlowCoolPump.Off</Key>" & _
...
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SL_PopUpPanel.btnAutoVentGeneral.On</Key>" & _
"      <Value>Would you like to Auto Vent ?</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SL_PopUpPanel.btnAutoVentGeneral.Off</Key>" & _
"      <Value>Would you like to Abort Auto Vent ?</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SL_PopUpPanel.btnAutoPumpDownGeneral.On</Key>" & _
"      <Value>Would you like to Auto Pump Down ?</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SL_PopUpPanel.btnAutoPumpDownGeneral.Off</Key>" & _
"      <Value>Would you like to Abort Auto Pump Down ?</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SL_PopUpPanel.btnRateOfRise.On</Key>" & _
"      <Value>Would you like to Run Rate Of Rise ?</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SL_PopUpPanel.btnRateOfRise.Off</Key>" & _
...
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SL_ProcessPanel.btnAutoLoad.On</Key>" & _
"      <Value>Would you like to Run Auto Load ?</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SL_ProcessPanel.btnAutoLoad.Off</Key>" & _
"      <Value>Would you like to Abort Auto Load ?</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SL_ProcessPanel.btnAutoUnload.On</Key>" & _
"      <Value>Would you like to Run Auto Unload ?</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SL_ProcessPanel.btnAutoUnload.Off</Key>" & _
"      <Value>Would you like to Abort Auto Unload ?</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SLProcessControl.btnCycle.On</Key>" & _
"      <Value>Would you like to Turn On Cycle Mode ?</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SLProcessControl.btnCycle.Off</Key>" & _
...
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SLFixture.btnRotate.On</Key>" & _
"      <Value>Would you like to Start Rotation Axis?</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SLFixture.btnRotate.Other</Key>" & _
"      <Value>Would you like to Rotation Home ?</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SLFixture.btnRotate.Off</Key>" & _
...
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SL_PopUpPanel.btnCryoOnOff.Off</Key>" & _
"      <Value>Would you like to Turn Cryo off?</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SL_PopUpPanel.btnCryoOnOff.On</Key>" & _
"      <Value>Would you like to Turn Cryo on?</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SL_PopUpPanel.btnWaterPumpOnOff.Off</Key>" & _
"      <Value>Would you like to Turn WaterPump Off ?</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SL_PopUpPanel.btnWaterPumpOnOff.On</Key>" & _
...
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SL_PopUpPanel.btnCryoRegenValve.Off</Key>" & _
"      <Value>Would you like to Close Cryo Regen Valve?</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SL_PopUpPanel.btnCryoRegenValve.On</Key>" & _
"      <Value>Would you like to Open Cryo Regen Valve ?</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SL_PopUpPanel.btnWaterPumpRegen.Off</Key>" & _
"      <Value>Would you like to Abort WaterPump Regen ?</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
"      <Key>SL.SL_PopUpPanel.btnWaterPumpRegen.On</Key>" & _
...
"      <Value>Loader Slit valve is not closed</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
...
"      <Value>Slit valve is not open</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
...
"      <Value>Slit valve is not closed</Value>" & _
"    </MessageText>" & _
"    <MessageText>" & _
...
"    <LoaderConfig>" & _
"      <Item Name=""ArmUpDownTimeOut"" Value=""60000"" />" & _
"      <Item Name=""ArmExtendRetractTimeOut"" Value=""60000"" />" & _
"      <Item Name=""RobotUpDownMotorWaitTime"" Value=""2000"" />" & _
"      <Item Name=""RobotExtenRetractMotorWaitTime"" Value=""2000"" />" & _
"      <Item Name=""IsolationValveOpenCloseTimeOut"" Value=""10000"" />" & _
"      <Item Name=""RoughValveOpenCloseTimeOut"" Value=""10000"" />" & _
"      <Item Name=""VentValveOpenCloseTimeOut"" Value=""10000"" />" & _
