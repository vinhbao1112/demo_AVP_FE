        ...
        Public Overrides Function Run(ByVal Message As String, _
            ...
            Try
                ...
                SyncLock m_CommandLock
                    Utils.LogMessageCheckPullingCryo(AVPLib.ContainerData.TypeEvent, "CryoTransaction.Run", " Sent: " + Message)
                        ...
                        Else
                            If (tscCommand.GetType().Name = "TSSingleReplyCheckSumCommand") Then
                                ...
                                If (String.IsNullOrEmpty(strReply)) Then
                                    ...
                                    blnResult = False
                                Else
                                    Utils.LogMessageCheckPullingCryo(AVPLib.ContainerData.TypeEvent, "CryoTransaction.Run", " Sent: " + Message + " Received: " + strReply)
