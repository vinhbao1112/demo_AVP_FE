Namespace XMLResources
    Public Class SL_IBE
        ...
        "    </Parameter>" & _
        "  </ParameterList>" & _
        "  <ParameterList Id=""3"" isGroup=""1"" Group=""DepositionBeamParameters"" GroupName=""DepositionBeamParameters"" ShowInUI=""True"">" & _
        "    <Parameter>" & _
        "      <SeqNo>1</SeqNo>" & _
        "      <Name>Beam_On</Name>" & _
        "      <Description>Beam_On</Description>" & _
        ...
        "    </Parameter>" & _
        "  </ParameterList>" & _
        "  <ParameterList Id=""5"" isGroup=""1"" Group=""DepositionGasParameters"" GroupName=""DepositionGasParameters"" ShowInUI=""True"">" & _
        "    <Parameter>" & _
        "      <SeqNo>1</SeqNo>" & _
        "      <Name>Value_1</Name>" & _
        "      <Description>Value_1</Description>" & _
        ...
        "      <SeqNo>34</SeqNo>" & _
        "      <Name>UseRGA</Name>" & _
        "      <Description>Use_RGA</Description>" & _
        "      <Default>No</Default>" & _
        "      <Unit>Boolean</Unit>" & _
        "      <ShowInUI>True</ShowInUI>" & _
        "      <DisplayItems>" & _
        ...
        "      <Description>Wait_For_GEM_Step_Time</Description>" & _
        "      <Default>No</Default>" & _
        "      <Unit>Boolean</Unit>" & _
        "      <ShowInUI>True</ShowInUI>" & _
        "      <DisplayItems>" & _
