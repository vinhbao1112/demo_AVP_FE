...
"<IBEServer>" & _
"	<!--Others-->" & _
"	<Command CommandName=""COPYRECIPE_TO_PMFOLDER"" CommandCode=""1,01,01,51,01,01"" PropertyName=""StartCopyRecipeToPMFolder"" Decoder=""""/>" & _
"	<Command CommandName=""MAINTENAINCE_MODE"" CommandCode=""1,01,01,50,01,01"" PropertyName=""MaintenanceMode"" Decoder=""""/>" & _
...
"  <Command CommandName=""ISOLATION_VALVE"" CommandCode=""1,02,01,15,01,01"" PropertyName="""" Decoder=""""/>" & _
"  <Command CommandName=""PUMP_PURGE"" CommandCode=""1,05,01,10,01,01"" PropertyName=""PumpPurgeStatus"" Decoder=""WorkingStatuses""/>" & _
"  <Command CommandName=""MachinePumpPurge_Current_Cycle"" CommandCode=""1,05,01,10,01,02"" PropertyName=""MachinePumpPurge_Current_Cycle"" Decoder=""String""/>" & _
"  <Command CommandName=""ION_GAUGE_DEGAS"" CommandCode=""1,02,01,08,01,03"" PropertyName=""IGDegasStatus"" Decoder=""WorkingStatuses""/>" & _
"" & _
"<Command CommandName=""SPLITVALVE_STATUS"" CommandCode=""1,12,25,01,01,0x"" PropertyName=""SlitValveStatus"" Decoder=""WorkingStatuses""/>" & _
"  " & _
"<Command CommandName=""RATE_OF_RISE_STATUS"" CommandCode=""1,02,01,20,01,01"" PropertyName=""RateOfRise_Status"" Decoder=""WorkingStatuses""/>" & _
"<Command CommandName=""RATE_OF_RISE_SAMPLE"" CommandCode=""1,02,04,20,01,01"" PropertyName=""RateOfRise_Sample"" Decoder=""""/>" & _
"<Command CommandName=""RATE_OF_RISE_FILENAME"" CommandCode=""1,02,03,20,01,01"" PropertyName=""RateOfRise_FileName"" Decoder=""""/>" & _
"<Command CommandName=""RATE_OF_RISE_INTERVAL_RECORDING"" CommandCode=""1,02,02,20,01,01"" PropertyName=""RateOfRise_Interval"" Decoder=""""/>" & _
"" & _
"<Command CommandName=""PUMPDOWN_CURVE_STATUS"" CommandCode=""1,02,01,21,01,01"" PropertyName=""PumpDown_Curve_Status"" Decoder=""WorkingStatuses""/>" & _
"<Command CommandName=""PUMPDOWN_CURVE_SAMPLE"" CommandCode=""1,02,04,21,01,01"" PropertyName=""PumpDown_Curve_Sample"" Decoder=""""/>" & _
"<Command CommandName=""PUMPDOWN_CURVE_FILENAME"" CommandCode=""1,02,03,21,01,01"" PropertyName=""PumpDown_Curve_FileName"" Decoder=""""/>" & _
"<Command CommandName=""PUMPDOWN_CURVE_INTERVAL_RECORDING"" CommandCode=""1,02,02,21,01,01"" PropertyName=""PumpDown_Curve_Interval"" Decoder=""""/>" & _
" <!--Cryo-->" & _
"  <Command CommandName=""CRYO_PUMP_TEMPERTURE_T1"" CommandCode=""1,02,01,04,01,10"" PropertyName=""Cryo_Pump_Temperture_T1"" Decoder=""Double""/>" & _
"  <Command CommandName=""CRYO_PUMP_TEMPERTURE_T2"" CommandCode=""1,02,01,04,01,02"" PropertyName=""Cryo_Pump_Temperture_T2"" Decoder=""Double""/>" & _
...
"  <Command CommandName=""CRYO_AUTO_REGEN_STATUS_TEXT"" CommandCode=""1,02,01,04,01,08"" PropertyName=""CryoAutoRegenStatusText"" Decoder=""String""/>" & _
...
"  <Command CommandName=""CRYO_P_COMMANDS"" CommandCode=""1,02,01,04,01,09"" PropertyName=""Cryo_P_Command"" Decoder=""String""/>" & _
"  " & _
"  <!--Status Panel-->" & _
...
"  <Command CommandName=""INITIALIZING_MOTION"" CommandCode=""1,03,01,13,01,01"" PropertyName=""Initializing_Motion_readback"" Decoder=""WorkingStatuses""/>" & _
...
"  <Command CommandName=""FIXTURE_ROTATION_MODE"" CommandCode=""1,03,01,08,01,05"" PropertyName=""Fixture_Rotation_Mode_Readback"" Decoder=""String""/>" & _
...
"  <Command CommandName=""FIXTURE_TILT_HOME"" CommandCode=""1,03,01,09,01,02"" PropertyName=""FixtureTiltHomeStatus"" Decoder=""WorkingStatuses""/>   " & _
"  <Command CommandName=""FIXTURE_ROTATION_MOVING"" CommandCode=""1,03,01,08,01,03"" PropertyName=""FixtureRotationMovingStatus"" Decoder=""WorkingStatuses""/>" & _
"  <Command CommandName=""FIXTURE_ROTATION_HOME"" CommandCode=""1,03,01,08,01,02"" PropertyName=""FixtureRotationHomeStatus"" Decoder=""WorkingStatuses""/>" & _
"  <Command CommandName=""FIXTURE_TILT_MOVING"" CommandCode=""1,03,01,09,01,03"" PropertyName=""FixtureTiltMovingStatus"" Decoder=""WorkingStatuses""/>" & _
"  <Command CommandName=""FIXTURE_TILT_ERROR"" CommandCode=""1,03,01,09,01,04"" PropertyName=""FixtureErrorStatus"" Decoder=""WorkingStatuses""/>" & _
"   " & _
...
"  <Command CommandName=""FIXTURE_UNPROTECTED"" CommandCode=""1,01,01,05,01,01"" PropertyName=""Fixture_Unprotected_Readback"" Decoder=""WorkingStatuses""/>" & _
...
"  <!--Pop Up Panel-->" & _
"  <Command CommandName=""PROCESS_CONTROL_GET_RUN_DATA_FILE_NAME"" CommandCode=""1,05,01,22,01,18"" PropertyName=""ProcessControl_GetRunDataFileName"" Decoder=""WorkingStatuses""/>" & _
"  <Command CommandName=""CURRENT_AVP_TIME"" CommandCode=""1,05,01,22,01,19"" PropertyName=""Current_AVP_Time"" Decoder=""String""/>" & _
"  <!--Power Panel-->" & _
...
"  <Command CommandName=""PROCESS_WAFER_ID"" CommandCode=""1,05,01,22,01,10"" PropertyName=""WaferID"" Decoder=""String""/>" & _
"  <Command CommandName=""SOURCE_USAGE_RESET"" CommandCode=""1,05,01,33,01,03"" PropertyName=""ResetSourceUsage"" Decoder=""String""/>" & _
"  <Command CommandName=""SOURCE_USAGE_TIMESET"" CommandCode=""1,05,01,33,01,01"" PropertyName=""SourceUsageTimeCurrent"" Decoder=""Double""/>" & _
"  <Command CommandName=""QUART_KWH"" CommandCode=""1,05,01,33,01,05"" PropertyName=""Shields_Quart_KWH"" Decoder=""Double""/>" & _
"  <!--SOURCE USAGE Warning Limit-->" & _
"  <Command CommandName=""SOURCE_USAGE_WARNING"" CommandCode=""1,05,01,33,01,07"" PropertyName="""" Decoder=""""/>" & _
"  <!--SOURCE USAGE Alarm Limit-->" & _
"   <Command CommandName=""SOURCE_USAGE_LIMIT"" CommandCode=""1,05,01,33,01,06"" PropertyName="""" Decoder=""""/>" & _
"   <!--MAX_SOURCE_USAGE Alarm Limit-->" & _
"   <Command CommandName=""MAX_SOURCE_USAGE"" CommandCode=""1,05,01,33,01,08"" PropertyName="""" Decoder=""""/>" & _
"" & _
"     <!--Pressure-->" & _
...
"  <Command CommandName=""PROCESS_CONTROL_SEND_RUN_DATA_FILE_NAME"" CommandCode=""1,05,01,22,01,17"" PropertyName="""" Decoder=""""/>" & _
"  <!--Chamber Interlock-->" & _
...
"  <Command CommandName=""FIXTURE_WATER_BUG_INTERLOCK"" CommandCode=""1,03,01,24,01,02"" PropertyName=""ChamberInterlocks_FixtureWaterBug_Status"" Decoder=""WorkingStatuses""/>" & _
...
"  <Command CommandName=""MPCG_RELAY_INDICATOR"" CommandCode=""1,02,01,09,03,02"" PropertyName=""MPCG_RelayIndicatorStatus"" Decoder=""WorkingStatuses""/>" & _
"  <!--Foreline CG -->" & _
"  <Command CommandName=""PIRANI_FORELINE_PRESSURE"" CommandCode=""1,02,01,07,02,01"" PropertyName=""CGCFLCG_Information"" Decoder=""Double""/>" & _
"  <!--Rough Pump CG -->" & _
...
"  <Command CommandName=""AUTOBEAM_PBN_GAS_FLOWRATE_PROGRAM"" CommandCode=""1,05,01,08,06,20"" PropertyName=""GasController_AutoBeam_PBN_Program"" Decoder=""Double""/>" & _
"  " & _
...
"" & _
"  <Command CommandName=""GAS1_FLOWRATE_PROGRAM"" CommandCode=""1,05,01,08,01,03"" PropertyName=""GasController_Gas1_Program"" Decoder=""Double""/>" & _
"  <Command CommandName=""GAS2_FLOWRATE_PROGRAM"" CommandCode=""1,05,01,08,02,03"" PropertyName=""GasController_Gas2_Program"" Decoder=""Double""/>" & _
"  <Command CommandName=""AUTOBEAM_GAS1_FLOWRATE_PROGRAM"" CommandCode=""1,05,01,08,01,20"" PropertyName=""GasController_AutoBeam_Gas1_Program"" Decoder=""Double""/>" & _
"  <Command CommandName=""AUTOBEAM_GAS2_FLOWRATE_PROGRAM"" CommandCode=""1,05,01,08,02,20"" PropertyName=""GasController_AutoBeam_Gas2_Program"" Decoder=""Double""/>" & _
"  <Command CommandName=""AUTOBEAM_GAS3_FLOWRATE_PROGRAM"" CommandCode=""1,05,01,08,03,20"" PropertyName=""GasController_AutoBeam_Gas3_Program"" Decoder=""Double""/>" & _
"  <Command CommandName=""AUTOBEAM_GAS4_FLOWRATE_PROGRAM"" CommandCode=""1,05,01,08,04,20"" PropertyName=""GasController_AutoBeam_Gas4_Program"" Decoder=""Double""/>" & _
"  <Command CommandName=""GAS3_FLOWRATE_PROGRAM"" CommandCode=""1,05,01,08,03,03"" PropertyName=""GasController_Gas3_Program"" Decoder=""Double""/>" & _
"  <Command CommandName=""GAS4_FLOWRATE_PROGRAM"" CommandCode=""1,05,01,08,04,03"" PropertyName=""GasController_Gas4_Program"" Decoder=""Double""/>" & _
"  <Command CommandName=""GAS5_FLOWRATE_PROGRAM"" CommandCode=""1,05,01,08,05,03"" PropertyName=""GasController_Gas5_Program"" Decoder=""Double""/>" & _
"" & _
"  <Command CommandName=""GAS1_FLOWRATE_READBACK"" CommandCode=""1,05,01,08,01,04"" PropertyName=""GasController_Gas1_Readback"" Decoder=""Double""/>" & _
"  <Command CommandName=""GAS2_FLOWRATE_READBACK"" CommandCode=""1,05,01,08,02,04"" PropertyName=""GasController_Gas2_Readback"" Decoder=""Double""/>" & _
"  <Command CommandName=""GAS3_FLOWRATE_READBACK"" CommandCode=""1,05,01,08,03,04"" PropertyName=""GasController_Gas3_Readback"" Decoder=""Double""/>" & _
"  <Command CommandName=""GAS4_FLOWRATE_READBACK"" CommandCode=""1,05,01,08,04,04"" PropertyName=""GasController_Gas4_Readback"" Decoder=""Double""/>" & _
"  <Command CommandName=""GAS5_FLOWRATE_READBACK"" CommandCode=""1,05,01,08,05,04"" PropertyName=""GasController_Gas5_Readback"" Decoder=""Double""/>" & _
"  " & _
"  <!--Shield Usage--> " & _
"  <Command CommandName=""COVER_FIXTURE_SHIELD_USAGE"" CommandCode=""1,05,01,33,01,11"" PropertyName=""CoverFixtureShieldUsageReadback"" Decoder=""Double""/> " & _
"  <Command CommandName=""TOP_FIXTURE_SHIELD_USAGE"" CommandCode=""1,05,01,33,01,12"" PropertyName=""TopFixtureShieldUsageReadback"" Decoder=""Double""/> " & _
"  <Command CommandName=""WAFER_CLAMP_USAGE"" CommandCode=""1,05,01,33,01,13"" PropertyName=""WaferClampUsageReadback"" Decoder=""Double""/> " & _
"  <Command CommandName=""SHUTTER_USAGE"" CommandCode=""1,05,01,33,01,14"" PropertyName=""ShutterUsageReadback"" Decoder=""Double""/> " & _
"  <Command CommandName=""FIXTURE_ROTATION_MOTOR_USAGE"" CommandCode=""1,05,01,33,01,15"" PropertyName=""FixtureRotationMotorUsageReadback"" Decoder=""Double""/> " & _
"		" & _
"<!--End Process Module-->" & _
"<!--Will be remove later-->" & _
...
"  <Command CommandName=""KEEP_ALIVE"" CommandCode=""1,00,00,00,00,00,00"" PropertyName="""" Decoder=""""/>" & _
"  </IBEServer>"
End Class
End Namespace
