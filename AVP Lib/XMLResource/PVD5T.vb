...
"    <Parameter>" & _
"      <SeqNo>2</SeqNo>" & _
"      <Name>PVD5T Process File Version 2.8</Name>" & _
"      <Description>PVD5T Process File Version 2.8</Description>" & _
"      <Default>" & _
"      </Default>" & _
"      <Unit>String</Unit>" & _
"      <ShowInUI>False</ShowInUI>" & _
...
"	<Parameter>" & _
"      <SeqNo>11</SeqNo>" & _
"      <Name>TargetMode</Name>" & _
"      <Description>Target mode (RF / DC)</Description>" & _
"      <Default>RF</Default>" & _
"      <Unit>Boolean</Unit>" & _
"      <ShowInUI>True</ShowInUI>" & _
"      <DisplayItems>" & _
"        <Item Value=""RF"" SeqNoDisable=""DCTargetPower:1,DCTargetPower:2,DCTargetPower:3,DCTargetPower:4,DCTargetPower:5,DCTargetPower:6"">RF</Item>" & _
"        <Item Value=""DC"" SeqNoDisable=""RFTargetPower:1,RFTargetPower:2,RFTargetPower:3,RFTargetPower:4,RFTargetPower:5,RFTargetPower:6,RFTargetPower:7,RFTargetPower:8,RFTargetPower:9"">DC</Item>" & _
"      </DisplayItems>" & _
"    </Parameter>" & _
"  </ParameterList>" & _
...
"      <Description>Target Selection (1-5)</Description>" & _
