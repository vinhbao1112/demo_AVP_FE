...
Namespace Business
    Public Enum PVD5TCommands
        ...
        TARGET5_SHIELD_QUART
        TARGET5_SET_SHIELD_QUART
        ' RECIPE_PROCESSING #2
        PROCESS_LOT_ID
        PROCESS_WAFER_ID
        PROCESS_RECIPE_NAME
        ...
        CHAMBERINTERLOCK_TARGET1_WATER_STATUS
        CHAMBERINTERLOCK_TARGET2_WATER_STATUS
        CHAMBERINTERLOCK_TARGET3_WATER_STATUS
        CHAMBERINTERLOCK_TARGET4_WATER_STATUS
        CHAMBERINTERLOCK_TARGET5_WATER_STATUS
        ...
        TARGET5_SHUTTER_STATUS
        CURRENT_SHUTTER_READBACK
        HOME_SHUTTER_STATUS
        SELECTED_SHUTTER_PROGRAM
        ...
        TARGET5_MAGNATRON_ON_OFF
        TARGET5_MAGNATRON_ROTATE_STATUS
        ...
        TARGET5_INJECTION_VALVE_STATUS
    ...
    Public Class PVD5TUtility
#Region "Public methods"
        Public Shared Function Check_Recipe_Template_Version(ByVal chamberName As String, ByVal data As String) As Boolean
            Return SendCommandWithDataToPVD5T(chamberName, PVD5TCommands.CHECK_RECIPE_TEMPLATE_VERSION.ToString(), data)
        End Function
        Public Shared Function DoSetSubstrate_Goto_Slot(ByVal val As String, ByVal EquipmentName As String) As Boolean
            ...
            Return SendCommandWithDataToPVD5T(EquipmentName, PVD5TCommands.SUBSTRATE_GOTO_SLOT.ToString(), val)
        ...
        Public Shared Function DoSetSubstrate_Table_Up_Down_Status(ByVal val As String, ByVal EquipmentName As String) As Boolean
            ...
            Return SendCommandWithDataToPVD5T(EquipmentName, PVD5TCommands.SUBSTRATE_TABLE_UP_DOWN_STATUS.ToString(), strData)
        ...
        Public Shared Function DoSetSubstrate_Table_Lift_Home(ByVal val As String, ByVal EquipmentName As String) As Boolean
            ...
            Dim strData As String = IIf(val = ConstEnum.STR_ON, ConfigurationValues.DEVICE_STATUS_OPEN, ConfigurationValues.DEVICE_STATUS_CLOSED)
            Return SendCommandWithDataToPVD5T(EquipmentName, PVD5TCommands.SUBSTRATE_TABLE_LIFT_HOME.ToString(), strData)
        ...
        Public Shared Function DoSetSubstrate_Lift_Up_Down_Status(ByVal val As String, ByVal EquipmentName As String) As Boolean
            ...
            Dim strData As String = IIf(val = ConstEnum.STR_ON, ConfigurationValues.DEVICE_STATUS_OPEN, ConfigurationValues.DEVICE_STATUS_CLOSED)
            Return SendCommandWithDataToPVD5T(EquipmentName, PVD5TCommands.SUBSTRATE_LIFT_UP_DOWN_STATUS.ToString(), strData)
        ...
        Public Shared Function Bias_Target_Auto(ByVal chamberName As String, ByVal data As String) As Boolean
            ...
            Select Case data
                Case STR_ON
                    Return SendCommandWithDataToPVD5T(chamberName, PVD5TCommands.BIAS_MB_MATCH_MODE_PROGRAM.ToString(), ConfigurationValues.DEVICE_STATUS_OPEN)
                Case STR_OFF
                    Return SendCommandWithDataToPVD5T(chamberName, PVD5TCommands.BIAS_MB_MATCH_MODE_PROGRAM.ToString(), ConfigurationValues.DEVICE_STATUS_CLOSED)
            End Select
        ...
        Public Shared Function RF_Target_Auto(ByVal chamberName As String, ByVal data As String) As Boolean
            ...
            Select Case data
                Case STR_ON
                    Return SendCommandWithDataToPVD5T(chamberName, PVD5TCommands.RF_TARGET_MB_MATCH_MODE_PROGRAM.ToString(), ConfigurationValues.DEVICE_STATUS_OPEN)
                Case STR_OFF
                    Return SendCommandWithDataToPVD5T(chamberName, PVD5TCommands.RF_TARGET_MB_MATCH_MODE_PROGRAM.ToString(), ConfigurationValues.DEVICE_STATUS_CLOSED)
            End Select
        End Function
        Public Shared Function Bias_Target_Recall(ByVal chamberName As String, ByVal data As String) As Boolean
            ...
            Return SendCommandWithDataToPVD5T(chamberName, PVD5TCommands.BIAS_MB_PRESET_RECALL_PROGRAM.ToString(), data)
        End Function
        Public Shared Function RF_Target_Recall(ByVal chamberName As String, ByVal data As String) As Boolean
            ...
            Return SendCommandWithDataToPVD5T(chamberName, PVD5TCommands.RF_TARGET_MB_PRESET_RECALL_PROGRAM.ToString(), data)
        End Function
        Public Shared Function Bias_Target_Store(ByVal chamberName As String, ByVal data As String) As Boolean
            ...
            Return SendCommandWithDataToPVD5T(chamberName, PVD5TCommands.BIAS_MB_PRESET_STORE_PROGRAM.ToString(), data)
        End Function
        Public Shared Function RF_Target_Store(ByVal chamberName As String, ByVal data As String) As Boolean
            ...
            Return SendCommandWithDataToPVD5T(chamberName, PVD5TCommands.RF_TARGET_MB_PRESET_STORE_PROGRAM.ToString(), data)
        End Function
...
#Region "Diagnostic Dialog"
        Public Shared Function Stop_PumpDown_Curve(ByVal strChamber As String) As Boolean
            ...
            Return SendCommandWithDataToPVD5T _
                   (strChamber, PVD5TCommands.PUMPDOWN_CURVE_SEQ.ToString(),
        ...
        Public Shared Function Start_PumpDown_Curve(ByVal strChamber As String, ByVal strSampleTime As String, ByVal strTotalTime As String, ByVal strDescription As String) As Boolean
            ...
            If SendCommandWithDataToPVD5T(strChamber,
                                                    PVD5TCommands.ISOLATION_VALVE_STATUS.ToString(),
                                                    IIf(IsPMIsoValveClose, ConfigurationValues.DEVICE_STATUS_CLOSED,
                                                        ConfigurationValues.DEVICE_STATUS_OPEN)) Then
                If SendCommandWithDataToPVD5T _
                  (strChamber, PVD5TCommands.PUMPDOWN_CURVE_INTERVAL_RECORDING.ToString(),
                   "Interval=" & strSampleTime & "#Period=" & strTotalTime &
        ...
        Public Shared Function Start_Rate_Of_Rise(ByVal strChamber As String, ByVal strSampleTime As String, ByVal strTotalTime As String, ByVal strDescription As String) As Boolean
            ...
            If SendCommandWithDataToPVD5T(strChamber,
                                                    ...
                                                    IIf(IsPMIsoValveClose, ConfigurationValues.DEVICE_STATUS_CLOSED,
                                                        ConfigurationValues.DEVICE_STATUS_OPEN)) Then
                If SendCommandWithDataToPVD5T _
                      (strChamber, PVD5TCommands.RATE_OF_RISE_INTERVAL_RECORDING.ToString(),
                       "Interval=" & strSampleTime & "#Period=" & strTotalTime &
                       "#Desc=" & strDescription & "#") Then
                    Return SendCommandWithDataToPVD5T _
                        (strChamber, PVD5TCommands.RATE_OF_RISE_SEQ.ToString(),
                         AVPLib.ConfigurationValues.DEVICE_STATUS_OPEN)
                End If
            End If
...
#End Region
        ...
        Public Shared Function SendCommandWithDataToPVD5T(ByVal chamberName As String, ByVal commandName As String, ByVal commandData As String) As Boolean
            AVPLib.Log.coreLogger.Info("Enter SendCommandWithDataToPVD5T")
            Try
                Dim commandCode As String = ContainerData.GetPVD5TCmdCode(commandName)
                If Not String.IsNullOrEmpty(commandCode) Then
                    ...
                    End If
                    AVPLib.Log.coreLogger.Info("Leave SendCommandWithDataToPVD5T")
        ...
        Public Shared Function SetWaferStatusToCorona(ByVal chamberName As String, ByVal data As String) As Boolean
            ...
            Return SendCommandWithDataToPVD5T(chamberName, PVD5TCommands.WAFER_PROCESSING_STATUS_READBACK.ToString(), data)
        End Function
        ...
        ''' </summary>
        Public Shared Function SetWaferDeleteToPVD5T(ByVal chamberName As String, ByVal slot As String) As Boolean
            Try
                Return SendCommandWithDataToPVD5T(chamberName, PVD5TCommands.WAFER_DELETE.ToString(), slot)
            Catch ex As Exception
                AVPLib.Log.coreLogger.Error(ex.ToString)
            End Try
        End Function
        ...
        ''' </summary>
        Public Shared Function SetWaferSlotToPVD5T(ByVal chamberName As String, ByVal slot As String) As Boolean
            Try
                Return SendCommandWithDataToPVD5T(chamberName, PVD5TCommands.WAFER_SLOT.ToString(), slot)
            Catch ex As Exception
                AVPLib.Log.coreLogger.Error(ex.ToString)
            End Try
        End Function
        ...
        Public Shared Sub UpdateWaferID(ByVal chamberName As String)
            Try
                ...
                Dim m_objChamber As DataManagerment.PVD5TChamber = DataManagerment.EquipmentManager.GetEquipment(chamberName)
                If (m_objChamber IsNot Nothing) Then
                    For index As Integer = 1 To m_objChamber.WaferCapacity
                        Dim objWaferInfo As AVPWaferInfo = Nothing
                        Dim gemWaferID As String = String.Empty

                        objWaferInfo = m_objChamber.GetWaferInfo(index)
